...
!  use m_udf_mms
  ...
  character(len=6) :: num
  REAL(kind=8) ::  DIV_MAX,tmp,DJ_ADJ,J_DU0,J_U,integ
  ...
  CALL COMPUTE_NON_LINEAR_SHEAR_TERMS(&
       A, Z, R, OPA, OPZ, OPR, UA, UZ, UR , PRM_A, PRM_B, NLAM1, NLZM1, NLRM1,&
  ...
  DO IT_time=1,nb_iter
     ...
     CALL COMPUTE_NON_LINEAR_SHEAR_TERMS(&
          A, Z, R, OPA, OPZ, OPR, UA, UZ, UR, PRM_A, PRM_B, NLA, NLZ, NLR,&
          DG01, DG02, DG03, DG04, DG05, DG06, DG07, DG08, DG09,DG10)
  ...
  if (do_adj) then
     ...
     CALL COMPUTE_ADJOINT_NON_LINEAR_SHEAR_TERMS_CYL(&
          A, Z, R, OPA, OPZ, OPR, DG04, DG05, DG06, UA, UZ, UR,prm_a,prm_b,NLAM1, NLZM1, NLRM1,&
          DG01, DG02, DG03, DG07, DG08, DG09, DG10,DG11,DG12,DG13,DG14)
...
!           DG06 = SAVE_UR(nb_iter-it_time+1,:,:,:)
        ...
        SA = (2._DP*UA-0.5_DP*UAM1)/DT - DG01 - DG04
        SZ = (2._DP*UZ-0.5_DP*UZM1)/DT - DG02 - DG05
        SR = (2._DP*UR-0.5_DP*URM1)/DT - DG03 - DG06
